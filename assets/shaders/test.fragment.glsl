...
void main() {
	vec2 uv = v_uv.xy / v_uv.z;
		...
		vec4 diffuse = texture2D(u_diffuseTexture, uv) * u_diffuseColor * v_color;
	#elif defined(diffuseTextureFlag) && defined(diffuseColorFlag)
		vec4 diffuse = texture2D(u_diffuseTexture, uv) * u_diffuseColor;
	#elif defined(diffuseTextureFlag) && defined(colorFlag)
		vec4 diffuse = texture2D(u_diffuseTexture, uv) * v_color;
